						...
						<div class="product-details">
							...
							<div class="add-to-cart">
								<form action="" method="post" id="add-to-cart-form">
									<input type="text" value="1" name="quantity['.$row['product_id'].']" size="2" />
									<button type="submit" class="add-to-cart-btn" pid="'.$row['product_id'].'"  id="product" ><i class="fa fa-shopping-cart"></i> add to cart</button>
								</form>
